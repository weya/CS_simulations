...
sinus5ch = zeros(1,dlzka+nuly_pred+nuly_za);
...
for i=1:dlzka
   ...
   sinus5ch(nuly_pred+i)=pom;
end

% %toto je signál bez šumu len kvôli snr
% for i=1:dlzka
...
% okno
okno = [zeros(1,nuly_pred) (chebwin(length(sinus5ch)-nuly_pred-nuly_za)') zeros(1,nuly_za)];
sinus5ch = sinus5ch.*okno;

% ulozenie matice
save sinus2.mat sinus5ch FVZ frekv;
